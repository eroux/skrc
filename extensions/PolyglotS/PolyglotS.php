...
*/
$wgPolyglotExcemptNamespaces = array(NS_CATEGORY, NS_FILE, NS_MEDIA, NS_SPECIAL, NS_MEDIAWIKI);
...
///// hook it up /////////////////////////////////////////////////////
$wgExtensionFunctions[] = "wfInitPolyglotExtension";
 ...
 */
function wfInitPolyglotExtension() {
 ...
 * 
 * 
 * @global array $wgPolyglotExcemptNamespaces
 * @global boolean $wgPolyglotExcemptTalkPages
 * @global boolean $wgPolyglotFollowRedirects
 * @global type $wgLang
 * @global type $wgContLang
 * @param type $title
 * @param type $request
 * @param type $ignoreRedirect
 * @param type $target
 * @param type $article
 * @return boolean
 */
